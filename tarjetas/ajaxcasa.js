...
function traerdatos() {
  ...
  xhttp.open("GET","datoscasa.json", true);
  xhttp.send()
}
...
function filtrarPrecio() {
    ...
    if (!isNaN(input)) {
                ...
                filter.forEach(result => {
                    ...
                    elemento.innerHTML = `
                        ...
                        <div class="tarjeta1-imagen">
                            <a href=""><img src="${result.img}"></a>
                            <p class="tarjeta1-p">Ubicación: ${result.ubicacion}\n</p>
                            <p class="tarjeta1-p">Ambiente: ${result.ambiente}\n</p>
                            <p class="tarjeta1-p">Superficie: ${result.superficie}\n</p>
                            <p class="tarjeta1-p"><b>Precio: ${result.precio}\n</b></p>
                        </div>
                        ;`
        ...
        peru.open("GET", "datoscasa.json", true);
        peru.send();
    } else {
            alert("Solo numeros!");
    }
